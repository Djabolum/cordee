...
from cordee.core.emotional_engine import archetype_priming, EmotionalState, get_archetype_by_emotional_context
...
def test_get_archetype_by_emotional_context():
    ...
    key = get_archetype_by_emotional_context(conflict=0.2, shakiness=0.1, signal="start")
